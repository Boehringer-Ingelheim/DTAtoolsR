...
```{r}
library(DTAtools)
yaml <- system.file("extdata", "gf_dataset.yaml", package = "DTAtools")

specs <- import_specs_from_yaml(yaml)
```
...
specs <- DTAColumnSpecCollection(specs = list(STUDYID = col1, VISIT = col2))
```
